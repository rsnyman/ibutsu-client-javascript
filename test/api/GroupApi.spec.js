...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @IbutsuClient.GroupApi();
  });
  ...
  describe('GroupApi', function() {
    ...
    describe('getGroupList', function() {
      it('should call getGroupList successfully', function(done) {
        //uncomment below and update the code to test getGroupList
        //instance.getGroupList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
